...
import {
  INTERNAL_NOTIFY_SEVERITY as SEVERITY,
  AUDIENCE_KIND,
  MIRROR_CHANNEL,
  audienceTargetSchema,
  notificationActionSchema as actionSchema,
  notificationDtoSchema,
  inboxRowSchema,
} from "@root/schemas/internal-notify";

// Schemas live in @root/schemas/internal-notify — see that file for shape +
// the discriminated audience-target union.
